...
class HuffmanUser
{
	...
	std::string matchCodes(std::string& match, unsigned char& tempByte, size_t& byteCounter, int& bytesToRead, std::unordered_map<std::string, unsigned char>& dictionary,
